 ...
 * `src/v1/reasoning_engine_service_client_config.json`.
...
class ReasoningEngineServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const createReasoningEngineResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.ReasoningEngine');
        const createReasoningEngineMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.CreateReasoningEngineOperationMetadata');
        const updateReasoningEngineResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.ReasoningEngine');
        const updateReasoningEngineMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.UpdateReasoningEngineOperationMetadata');
        const deleteReasoningEngineResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteReasoningEngineMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.DeleteOperationMetadata');
        this.descriptors.longrunning = {
            ...
            updateReasoningEngine: new this._gaxModule.LongrunningDescriptor(this.operationsClient, updateReasoningEngineResponse.decode.bind(updateReasoningEngineResponse), updateReasoningEngineMetadata.decode.bind(updateReasoningEngineMetadata)),
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.aiplatform.v1.ReasoningEngineService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.reasoningEngineServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.aiplatform.v1.ReasoningEngineService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.aiplatform.v1.ReasoningEngineService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const reasoningEngineServiceStubMethods = ['createReasoningEngine', 'getReasoningEngine', 'listReasoningEngines', 'updateReasoningEngine', 'deleteReasoningEngine'];
    ...
    getReasoningEngine(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls.getReasoningEngine(request, options, wrappedCallback)
    ...
    createReasoningEngine(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.createReasoningEngine(request, options, wrappedCallback)
    ...
    updateReasoningEngine(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        return this.innerApiCalls.updateReasoningEngine(request, options, wrappedCallback)
            ?.then(([response, rawResponse, _]) => {
            this._log.info('updateReasoningEngine response %j', rawResponse);
            return [response, rawResponse, _];
        });
     ...
     */
    async checkUpdateReasoningEngineProgress(name) {
    ...
    deleteReasoningEngine(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.deleteReasoningEngine(request, options, wrappedCallback)
            ?.then(([response, rawResponse, _]) => {
            this._log.info('deleteReasoningEngine response %j', rawResponse);
            return [response, rawResponse, _];
        });
