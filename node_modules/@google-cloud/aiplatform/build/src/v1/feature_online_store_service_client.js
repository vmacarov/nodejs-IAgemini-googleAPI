...
class FeatureOnlineStoreServiceClient {
    ...
    initialize() {
        ...
        this.featureOnlineStoreServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            ...
            this._protos.google.cloud.aiplatform.v1.FeatureOnlineStoreService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const featureOnlineStoreServiceStubMethods = ['fetchFeatureValues', 'searchNearestEntities'];
