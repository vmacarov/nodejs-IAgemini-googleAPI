...
class GenAiTuningServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const rebaseTunedModelResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.TuningJob');
        const rebaseTunedModelMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.RebaseTunedModelOperationMetadata');
