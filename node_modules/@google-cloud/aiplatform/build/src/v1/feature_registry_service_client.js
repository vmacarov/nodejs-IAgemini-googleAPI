...
class FeatureRegistryServiceClient {
    ...
    initialize() {
        ...
        this.featureRegistryServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            ...
            this._protos.google.cloud.aiplatform.v1.FeatureRegistryService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const featureRegistryServiceStubMethods = ['createFeatureGroup', 'getFeatureGroup', 'listFeatureGroups', 'updateFeatureGroup', 'deleteFeatureGroup', 'createFeature', 'batchCreateFeatures', 'getFeature', 'listFeatures', 'updateFeature', 'deleteFeature'];
