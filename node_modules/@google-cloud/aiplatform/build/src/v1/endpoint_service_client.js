...
class EndpointServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const updateEndpointLongRunningResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.Endpoint');
        const updateEndpointLongRunningMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.UpdateEndpointOperationMetadata');
    ...
    initialize() {
        ...
        const endpointServiceStubMethods = ['createEndpoint', 'getEndpoint', 'listEndpoints', 'updateEndpoint', 'updateEndpointLongRunning', 'deleteEndpoint', 'deployModel', 'undeployModel', 'mutateDeployedModel'];
