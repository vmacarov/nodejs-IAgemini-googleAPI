...
class VertexRagDataServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const createRagCorpusResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.RagCorpus');
        const createRagCorpusMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.CreateRagCorpusOperationMetadata');
        const updateRagCorpusResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.RagCorpus');
        const updateRagCorpusMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.UpdateRagCorpusOperationMetadata');
        const deleteRagCorpusResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteRagCorpusMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.DeleteOperationMetadata');
        const importRagFilesResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.ImportRagFilesResponse');
        const importRagFilesMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.ImportRagFilesOperationMetadata');
        const deleteRagFileResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteRagFileMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.DeleteOperationMetadata');
        this.descriptors.longrunning = {
            ...
            updateRagCorpus: new this._gaxModule.LongrunningDescriptor(this.operationsClient, updateRagCorpusResponse.decode.bind(updateRagCorpusResponse), updateRagCorpusMetadata.decode.bind(updateRagCorpusMetadata)),
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.aiplatform.v1.VertexRagDataService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.vertexRagDataServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.aiplatform.v1.VertexRagDataService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.aiplatform.v1.VertexRagDataService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const vertexRagDataServiceStubMethods = ['createRagCorpus', 'updateRagCorpus', 'getRagCorpus', 'listRagCorpora', 'deleteRagCorpus', 'uploadRagFile', 'importRagFiles', 'getRagFile', 'listRagFiles', 'deleteRagFile'];
    ...
    updateRagCorpus(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkUpdateRagCorpusProgress(name) {
