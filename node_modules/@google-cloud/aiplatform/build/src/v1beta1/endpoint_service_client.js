...
class EndpointServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const updateEndpointLongRunningResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.Endpoint');
        const updateEndpointLongRunningMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.UpdateEndpointOperationMetadata');
        ...
        const setPublisherModelConfigResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.PublisherModelConfig');
        const setPublisherModelConfigMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.SetPublisherModelConfigOperationMetadata');
        this.descriptors.longrunning = {
            ...
            updateEndpointLongRunning: new this._gaxModule.LongrunningDescriptor(this.operationsClient, updateEndpointLongRunningResponse.decode.bind(updateEndpointLongRunningResponse), updateEndpointLongRunningMetadata.decode.bind(updateEndpointLongRunningMetadata)),
            ...
            setPublisherModelConfig: new this._gaxModule.LongrunningDescriptor(this.operationsClient, setPublisherModelConfigResponse.decode.bind(setPublisherModelConfigResponse), setPublisherModelConfigMetadata.decode.bind(setPublisherModelConfigMetadata))
        };
    ...
    initialize() {
        ...
        const endpointServiceStubMethods = ['createEndpoint', 'getEndpoint', 'listEndpoints', 'updateEndpoint', 'updateEndpointLongRunning', 'deleteEndpoint', 'deployModel', 'undeployModel', 'mutateDeployedModel', 'setPublisherModelConfig', 'fetchPublisherModelConfig'];
    ...
    fetchPublisherModelConfig(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    updateEndpointLongRunning(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkUpdateEndpointLongRunningProgress(name) {
    ...
    setPublisherModelConfig(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkSetPublisherModelConfigProgress(name) {
