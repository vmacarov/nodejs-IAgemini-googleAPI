...
exports.GenAiCacheServiceClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta1/gen_ai_cache_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./gen_ai_cache_service_client_config.json");
...
class GenAiCacheServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.aiplatform.v1beta1.GenAiCacheService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.genAiCacheServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.aiplatform.v1beta1.GenAiCacheService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.aiplatform.v1beta1.GenAiCacheService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const genAiCacheServiceStubMethods = ['createCachedContent', 'getCachedContent', 'updateCachedContent', 'deleteCachedContent', 'listCachedContents'];
        for (const methodName of genAiCacheServiceStubMethods) {
            const callPromise = this.genAiCacheServiceStub.then(stub => (...args) => {
                if (this._terminated) {
...
//# sourceMappingURL=gen_ai_cache_service_client.js.map