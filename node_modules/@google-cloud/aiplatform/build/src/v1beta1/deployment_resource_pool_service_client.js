...
class DeploymentResourcePoolServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const updateDeploymentResourcePoolResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.DeploymentResourcePool');
        const updateDeploymentResourcePoolMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.UpdateDeploymentResourcePoolOperationMetadata');
    ...
    initialize() {
        ...
        this.deploymentResourcePoolServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            ...
            this._protos.google.cloud.aiplatform.v1beta1.DeploymentResourcePoolService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const deploymentResourcePoolServiceStubMethods = ['createDeploymentResourcePool', 'getDeploymentResourcePool', 'listDeploymentResourcePools', 'updateDeploymentResourcePool', 'deleteDeploymentResourcePool', 'queryDeployedModels'];
