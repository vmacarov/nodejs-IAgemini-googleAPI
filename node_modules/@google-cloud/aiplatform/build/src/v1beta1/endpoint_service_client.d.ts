...
export declare class EndpointServiceClient {
     ...
     */
    updateEndpointLongRunning(request?: protos.google.cloud.aiplatform.v1beta1.IUpdateEndpointLongRunningRequest, options?: CallOptions): Promise<[
    ...
    updateEndpointLongRunning(request: protos.google.cloud.aiplatform.v1beta1.IUpdateEndpointLongRunningRequest, options: CallOptions, callback: Callback<LROperation<protos.google.cloud.aiplatform.v1beta1.IEndpoint, protos.google.cloud.aiplatform.v1beta1.IUpdateEndpointOperationMetadata>, protos.google.longrunning.IOperation | null | undefined, {} | null | undefined>): void;
    updateEndpointLongRunning(request: protos.google.cloud.aiplatform.v1beta1.IUpdateEndpointLongRunningRequest, callback: Callback<LROperation<protos.google.cloud.aiplatform.v1beta1.IEndpoint, protos.google.cloud.aiplatform.v1beta1.IUpdateEndpointOperationMetadata>, protos.google.longrunning.IOperation | null | undefined, {} | null | undefined>): void;
    /**
     ...
     */
    setPublisherModelConfig(request?: protos.google.cloud.aiplatform.v1beta1.ISetPublisherModelConfigRequest, options?: CallOptions): Promise<[
    ...
    setPublisherModelConfig(request: protos.google.cloud.aiplatform.v1beta1.ISetPublisherModelConfigRequest, options: CallOptions, callback: Callback<LROperation<protos.google.cloud.aiplatform.v1beta1.IPublisherModelConfig, protos.google.cloud.aiplatform.v1beta1.ISetPublisherModelConfigOperationMetadata>, protos.google.longrunning.IOperation | null | undefined, {} | null | undefined>): void;
    setPublisherModelConfig(request: protos.google.cloud.aiplatform.v1beta1.ISetPublisherModelConfigRequest, callback: Callback<LROperation<protos.google.cloud.aiplatform.v1beta1.IPublisherModelConfig, protos.google.cloud.aiplatform.v1beta1.ISetPublisherModelConfigOperationMetadata>, protos.google.longrunning.IOperation | null | undefined, {} | null | undefined>): void;
    /**
