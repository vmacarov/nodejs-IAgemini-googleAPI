...
export declare class VertexRagServiceClient {
     ...
     */
    augmentPrompt(request?: protos.google.cloud.aiplatform.v1beta1.IAugmentPromptRequest, options?: CallOptions): Promise<[
    ...
    augmentPrompt(request: protos.google.cloud.aiplatform.v1beta1.IAugmentPromptRequest, options: CallOptions, callback: Callback<protos.google.cloud.aiplatform.v1beta1.IAugmentPromptResponse, protos.google.cloud.aiplatform.v1beta1.IAugmentPromptRequest | null | undefined, {} | null | undefined>): void;
    augmentPrompt(request: protos.google.cloud.aiplatform.v1beta1.IAugmentPromptRequest, callback: Callback<protos.google.cloud.aiplatform.v1beta1.IAugmentPromptResponse, protos.google.cloud.aiplatform.v1beta1.IAugmentPromptRequest | null | undefined, {} | null | undefined>): void;
    /**
     ...
     */
    corroborateContent(request?: protos.google.cloud.aiplatform.v1beta1.ICorroborateContentRequest, options?: CallOptions): Promise<[
    ...
    corroborateContent(request: protos.google.cloud.aiplatform.v1beta1.ICorroborateContentRequest, options: CallOptions, callback: Callback<protos.google.cloud.aiplatform.v1beta1.ICorroborateContentResponse, protos.google.cloud.aiplatform.v1beta1.ICorroborateContentRequest | null | undefined, {} | null | undefined>): void;
    corroborateContent(request: protos.google.cloud.aiplatform.v1beta1.ICorroborateContentRequest, callback: Callback<protos.google.cloud.aiplatform.v1beta1.ICorroborateContentResponse, protos.google.cloud.aiplatform.v1beta1.ICorroborateContentRequest | null | undefined, {} | null | undefined>): void;
    /**
