...
class PersistentResourceServiceClient {
    ...
    initialize() {
        ...
        this.persistentResourceServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            ...
            this._protos.google.cloud.aiplatform.v1beta1.PersistentResourceService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const persistentResourceServiceStubMethods = ['createPersistentResource', 'getPersistentResource', 'listPersistentResources', 'deletePersistentResource', 'updatePersistentResource', 'rebootPersistentResource'];
