...
exports.ExampleStoreServiceClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta1/example_store_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./example_store_service_client_config.json");
...
class ExampleStoreServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            listExampleStores: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'exampleStores'),
            fetchExamples: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'examples')
        };
        ...
        const createExampleStoreResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.ExampleStore');
        const createExampleStoreMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.CreateExampleStoreOperationMetadata');
        const updateExampleStoreResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.ExampleStore');
        const updateExampleStoreMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.UpdateExampleStoreOperationMetadata');
        const deleteExampleStoreResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteExampleStoreMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.DeleteExampleStoreOperationMetadata');
        this.descriptors.longrunning = {
            createExampleStore: new this._gaxModule.LongrunningDescriptor(this.operationsClient, createExampleStoreResponse.decode.bind(createExampleStoreResponse), createExampleStoreMetadata.decode.bind(createExampleStoreMetadata)),
            updateExampleStore: new this._gaxModule.LongrunningDescriptor(this.operationsClient, updateExampleStoreResponse.decode.bind(updateExampleStoreResponse), updateExampleStoreMetadata.decode.bind(updateExampleStoreMetadata)),
            deleteExampleStore: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deleteExampleStoreResponse.decode.bind(deleteExampleStoreResponse), deleteExampleStoreMetadata.decode.bind(deleteExampleStoreMetadata))
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.aiplatform.v1beta1.ExampleStoreService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.exampleStoreServiceStub) {
            return this.exampleStoreServiceStub;
        }
        // Put together the "service stub" for
        // google.cloud.aiplatform.v1beta1.ExampleStoreService.
        this.exampleStoreServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.aiplatform.v1beta1.ExampleStoreService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.aiplatform.v1beta1.ExampleStoreService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const exampleStoreServiceStubMethods = ['createExampleStore', 'getExampleStore', 'updateExampleStore', 'deleteExampleStore', 'listExampleStores', 'upsertExamples', 'removeExamples', 'searchExamples', 'fetchExamples'];
        for (const methodName of exampleStoreServiceStubMethods) {
            const callPromise = this.exampleStoreServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getExampleStore(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this._log.info('getExampleStore request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('getExampleStore response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.getExampleStore(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('getExampleStore response %j', response);
            return [response, options, rawResponse];
        });
    }
    upsertExamples(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        options.otherArgs.headers = options.otherArgs.headers || {};
        options.otherArgs.headers['x-goog-request-params'] = this._gaxModule.routingHeader.fromParams({
            'example_store': request.exampleStore ?? '',
        });
        this.initialize().catch(err => { throw err; });
        this._log.info('upsertExamples request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('upsertExamples response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.upsertExamples(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('upsertExamples response %j', response);
            return [response, options, rawResponse];
        });
    }
    removeExamples(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        this.initialize().catch(err => { throw err; });
        this._log.info('removeExamples request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('removeExamples response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.removeExamples(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('removeExamples response %j', response);
            return [response, options, rawResponse];
        });
    }
    searchExamples(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        this.initialize().catch(err => { throw err; });
        this._log.info('searchExamples request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('searchExamples response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.searchExamples(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('searchExamples response %j', response);
            return [response, options, rawResponse];
        });
    }
    createExampleStore(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        const wrappedCallback = callback
            ? (error, response, rawResponse, _) => {
                this._log.info('createExampleStore response %j', rawResponse);
                callback(error, response, rawResponse, _); // We verified callback above.
            }
            : undefined;
        this._log.info('createExampleStore request %j', request);
        return this.innerApiCalls.createExampleStore(request, options, wrappedCallback)
     ...
     */
    async checkCreateExampleStoreProgress(name) {
        this._log.info('createExampleStore long-running');
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
        const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.createExampleStore, this._gaxModule.createDefaultBackoffSettings());
        return decodeOperation;
    }
    updateExampleStore(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        options.otherArgs.headers = options.otherArgs.headers || {};
        options.otherArgs.headers['x-goog-request-params'] = this._gaxModule.routingHeader.fromParams({
            'example_store.name': request.exampleStore.name ?? '',
        });
        this.initialize().catch(err => { throw err; });
        const wrappedCallback = callback
            ? (error, response, rawResponse, _) => {
                this._log.info('updateExampleStore response %j', rawResponse);
                callback(error, response, rawResponse, _); // We verified callback above.
            }
            : undefined;
        this._log.info('updateExampleStore request %j', request);
        return this.innerApiCalls.updateExampleStore(request, options, wrappedCallback)
            ?.then(([response, rawResponse, _]) => {
            this._log.info('updateExampleStore response %j', rawResponse);
            return [response, rawResponse, _];
        });
     ...
     */
    async checkUpdateExampleStoreProgress(name) {
        this._log.info('updateExampleStore long-running');
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
        const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.updateExampleStore, this._gaxModule.createDefaultBackoffSettings());
        return decodeOperation;
    }
    deleteExampleStore(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        const wrappedCallback = callback
            ? (error, response, rawResponse, _) => {
                this._log.info('deleteExampleStore response %j', rawResponse);
                callback(error, response, rawResponse, _); // We verified callback above.
            }
            : undefined;
        this._log.info('deleteExampleStore request %j', request);
        return this.innerApiCalls.deleteExampleStore(request, options, wrappedCallback)
            ?.then(([response, rawResponse, _]) => {
            this._log.info('deleteExampleStore response %j', rawResponse);
            return [response, rawResponse, _];
        });
     ...
     */
    async checkDeleteExampleStoreProgress(name) {
        this._log.info('deleteExampleStore long-running');
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
        const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.deleteExampleStore, this._gaxModule.createDefaultBackoffSettings());
        return decodeOperation;
    }
    listExampleStores(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        const wrappedCallback = callback
            ? (error, values, nextPageRequest, rawResponse) => {
                this._log.info('listExampleStores values %j', values);
                callback(error, values, nextPageRequest, rawResponse); // We verified callback above.
            }
            : undefined;
        this._log.info('listExampleStores request %j', request);
        return this.innerApiCalls
            .listExampleStores(request, options, wrappedCallback)
            ?.then(([response, input, output]) => {
            this._log.info('listExampleStores values %j', response);
     ...
     *   for more details and examples.
     */
    listExampleStoresStream(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        const defaultCallSettings = this._defaults['listExampleStores'];
        const callSettings = defaultCallSettings.merge(options);
        this.initialize().catch(err => { throw err; });
        this._log.info('listExampleStores stream %j', request);
        return this.descriptors.page.listExampleStores.createStream(this.innerApiCalls.listExampleStores, request, callSettings);
    }
    /**
     ...
     */
    listExampleStoresAsync(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize().catch(err => { throw err; });
        this._log.info('listExampleStores iterate %j', request);
        return this.descriptors.page.listExampleStores.asyncIterate(this.innerApiCalls['listExampleStores'], request, callSettings);
    }
    fetchExamples(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        const wrappedCallback = callback
            ? (error, values, nextPageRequest, rawResponse) => {
                this._log.info('fetchExamples values %j', values);
                callback(error, values, nextPageRequest, rawResponse); // We verified callback above.
            }
            : undefined;
        this._log.info('fetchExamples request %j', request);
        return this.innerApiCalls
            .fetchExamples(request, options, wrappedCallback)
            ?.then(([response, input, output]) => {
            this._log.info('fetchExamples values %j', response);
            return [response, input, output];
        });
    }
    /**
     ...
     *   for more details and examples.
     */
    fetchExamplesStream(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        const defaultCallSettings = this._defaults['fetchExamples'];
        const callSettings = defaultCallSettings.merge(options);
        this.initialize().catch(err => { throw err; });
        this._log.info('fetchExamples stream %j', request);
        return this.descriptors.page.fetchExamples.createStream(this.innerApiCalls.fetchExamples, request, callSettings);
    }
    /**
     ...
     */
    fetchExamplesAsync(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize().catch(err => { throw err; });
        this._log.info('fetchExamples iterate %j', request);
        return this.descriptors.page.fetchExamples.asyncIterate(this.innerApiCalls['fetchExamples'], request, callSettings);
    }
    /**
     ...
     */
    close() {
        if (this.exampleStoreServiceStub && !this._terminated) {
            return this.exampleStoreServiceStub.then(stub => {
...
exports.ExampleStoreServiceClient = ExampleStoreServiceClient;
//# sourceMappingURL=example_store_service_client.js.map