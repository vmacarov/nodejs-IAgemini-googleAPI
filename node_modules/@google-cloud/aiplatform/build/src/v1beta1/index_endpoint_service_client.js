...
class IndexEndpointServiceClient {
    ...
    initialize() {
        ...
        this.indexEndpointServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            ...
            this._protos.google.cloud.aiplatform.v1beta1.IndexEndpointService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const indexEndpointServiceStubMethods = ['createIndexEndpoint', 'getIndexEndpoint', 'listIndexEndpoints', 'updateIndexEndpoint', 'deleteIndexEndpoint', 'deployIndex', 'undeployIndex', 'mutateDeployedIndex'];
