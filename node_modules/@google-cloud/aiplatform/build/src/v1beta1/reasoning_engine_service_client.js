...
class ReasoningEngineServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const updateReasoningEngineResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.ReasoningEngine');
        const updateReasoningEngineMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.UpdateReasoningEngineOperationMetadata');
    ...
    initialize() {
        ...
        this.reasoningEngineServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            ...
            this._protos.google.cloud.aiplatform.v1beta1.ReasoningEngineService, this._opts, this._providedCustomServicePath);
