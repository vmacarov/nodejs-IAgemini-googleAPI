...
class EvaluationServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const evaluateDatasetResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.EvaluateDatasetResponse');
        const evaluateDatasetMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.EvaluateDatasetOperationMetadata');
        this.descriptors.longrunning = {
            evaluateDataset: new this._gaxModule.LongrunningDescriptor(this.operationsClient, evaluateDatasetResponse.decode.bind(evaluateDatasetResponse), evaluateDatasetMetadata.decode.bind(evaluateDatasetMetadata))
        };
    ...
    initialize() {
        ...
        this.evaluationServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            ...
            this._protos.google.cloud.aiplatform.v1beta1.EvaluationService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const evaluationServiceStubMethods = ['evaluateInstances', 'evaluateDataset'];
    ...
    evaluateDataset(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkEvaluateDatasetProgress(name) {
