...
class ModelGardenServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const deployResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.DeployResponse');
        const deployMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.DeployOperationMetadata');
        const deployPublisherModelResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.DeployPublisherModelResponse');
        const deployPublisherModelMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.DeployPublisherModelOperationMetadata');
        const exportPublisherModelResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.ExportPublisherModelResponse');
        const exportPublisherModelMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.ExportPublisherModelOperationMetadata');
        this.descriptors.longrunning = {
            deploy: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deployResponse.decode.bind(deployResponse), deployMetadata.decode.bind(deployMetadata)),
            deployPublisherModel: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deployPublisherModelResponse.decode.bind(deployPublisherModelResponse), deployPublisherModelMetadata.decode.bind(deployPublisherModelMetadata)),
            exportPublisherModel: new this._gaxModule.LongrunningDescriptor(this.operationsClient, exportPublisherModelResponse.decode.bind(exportPublisherModelResponse), exportPublisherModelMetadata.decode.bind(exportPublisherModelMetadata))
        };
    ...
    initialize() {
        ...
        this.modelGardenServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            ...
            this._protos.google.cloud.aiplatform.v1beta1.ModelGardenService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const modelGardenServiceStubMethods = ['getPublisherModel', 'listPublisherModels', 'deploy', 'deployPublisherModel', 'exportPublisherModel', 'checkPublisherModelEulaAcceptance', 'acceptPublisherModelEula'];
    ...
    checkPublisherModelEulaAcceptance(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    acceptPublisherModelEula(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    deploy(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkDeployProgress(name) {
    ...
    deployPublisherModel(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkDeployPublisherModelProgress(name) {
    ...
    exportPublisherModel(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkExportPublisherModelProgress(name) {
