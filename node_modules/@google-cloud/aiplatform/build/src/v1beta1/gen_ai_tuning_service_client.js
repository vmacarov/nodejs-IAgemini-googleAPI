...
class GenAiTuningServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const rebaseTunedModelResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.TuningJob');
        const rebaseTunedModelMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.RebaseTunedModelOperationMetadata');
        this.descriptors.longrunning = {
            rebaseTunedModel: new this._gaxModule.LongrunningDescriptor(this.operationsClient, rebaseTunedModelResponse.decode.bind(rebaseTunedModelResponse), rebaseTunedModelMetadata.decode.bind(rebaseTunedModelMetadata))
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.aiplatform.v1beta1.GenAiTuningService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.genAiTuningServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.aiplatform.v1beta1.GenAiTuningService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.aiplatform.v1beta1.GenAiTuningService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const genAiTuningServiceStubMethods = ['createTuningJob', 'getTuningJob', 'listTuningJobs', 'cancelTuningJob', 'rebaseTunedModel'];
    ...
    rebaseTunedModel(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkRebaseTunedModelProgress(name) {
