...
class VertexRagDataServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const updateRagCorpusResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.RagCorpus');
        const updateRagCorpusMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.UpdateRagCorpusOperationMetadata');
        ...
        const updateRagEngineConfigResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.RagEngineConfig');
        const updateRagEngineConfigMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.UpdateRagEngineConfigOperationMetadata');
        this.descriptors.longrunning = {
            ...
            updateRagEngineConfig: new this._gaxModule.LongrunningDescriptor(this.operationsClient, updateRagEngineConfigResponse.decode.bind(updateRagEngineConfigResponse), updateRagEngineConfigMetadata.decode.bind(updateRagEngineConfigMetadata))
        };
    ...
    initialize() {
        ...
        this.vertexRagDataServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            ...
            this._protos.google.cloud.aiplatform.v1beta1.VertexRagDataService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const vertexRagDataServiceStubMethods = ['createRagCorpus', 'updateRagCorpus', 'getRagCorpus', 'listRagCorpora', 'deleteRagCorpus', 'uploadRagFile', 'importRagFiles', 'getRagFile', 'listRagFiles', 'deleteRagFile', 'updateRagEngineConfig', 'getRagEngineConfig'];
    ...
    getRagEngineConfig(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    updateRagEngineConfig(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkUpdateRagEngineConfigProgress(name) {
