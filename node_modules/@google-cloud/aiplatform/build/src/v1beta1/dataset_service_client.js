...
class DatasetServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const assessDataResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.AssessDataResponse');
        const assessDataMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.AssessDataOperationMetadata');
        const assembleDataResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.AssembleDataResponse');
        const assembleDataMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.AssembleDataOperationMetadata');
        this.descriptors.longrunning = {
            ...
            assessData: new this._gaxModule.LongrunningDescriptor(this.operationsClient, assessDataResponse.decode.bind(assessDataResponse), assessDataMetadata.decode.bind(assessDataMetadata)),
            assembleData: new this._gaxModule.LongrunningDescriptor(this.operationsClient, assembleDataResponse.decode.bind(assembleDataResponse), assembleDataMetadata.decode.bind(assembleDataMetadata))
        };
    ...
    assessData(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkAssessDataProgress(name) {
    ...
    assembleData(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkAssembleDataProgress(name) {
